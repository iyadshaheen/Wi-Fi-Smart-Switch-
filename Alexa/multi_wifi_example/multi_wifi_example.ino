...
#define MyApiKey "8eaf354b-a7d4-4ec8-85ba-0e3c0a4b02fc" // TODO: Change to your sinric API Key. Your API Key is displayed on sinric.com dashboard
#define lamp0 "5c42e79f83aff924b32ec06f"
#define lamp1 "5c4331472069f45a06714bcb"
...
void turnOn(String deviceId) {
  if (deviceId == lamp0) // Device ID of first device
  {  
   ...
   else if (deviceId == lamp1) // Device ID of second device
 { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
         digitalWrite (4,HIGH);    
